...
module VX_cp_engine_top (
	...
	parameter [0:0] ENABLE_NOP_FAST_PATH = 1'b0;
	...
	generate
		if (1) begin : u_engine
			...
			assign start_evt = ((fsm == 3'd2) && cur_cmd[264]) && (((((cur_res == 2'd0) && bid_kmu_if.grant) || ((cur_res == 2'd1) && bid_dma_if.grant)) || ((cur_res == 2'd2) && bid_dcr_if.grant)) || ((cur_res == 2'd3) && bid_event_if.grant));
